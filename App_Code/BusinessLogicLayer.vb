...
Public Class BusinessLogicLayer
    ...
    Public Function GenerateRandomNumber(ByRef iLength As Integer) As String
    ...
    Public Function BindCountry() As DataTable
        Dim mDataTable As DataTable
        Try
            mDataTable = ExecDataTable("Select * from Country order by CountryName")
        Catch ex As Exception
            mDataTable = Nothing
        Finally
    ...
    End Sub
    Sub AddUpdateReviews(ByVal cnt As Integer, ByVal Title As String, ByVal ImageName As String, ByVal Review As String, ByVal ReviewDate As String, ByVal Deactivated As Integer, ByVal ShowOnHomePage As Integer, ByVal UserName As String)
        Dim arrList As New ArrayList
        arrList.Add(PrepareCommand("@cnt", cnt, SqlDbType.Int, 0, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@Title", Title, SqlDbType.NVarChar, 8000, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@ImageName", ImageName, SqlDbType.VarChar, 200, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@ReviewDate", ReviewDate, SqlDbType.VarChar, 20, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@Review", Review, SqlDbType.NVarChar, 8000, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@Deactivated", Deactivated, SqlDbType.Int, 0, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@ShowOnHomePage", ShowOnHomePage, SqlDbType.Int, 0, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@UserName", UserName, SqlDbType.VarChar, 200, ParameterDirection.Input))
        ExecNonQueryProc("Prc_AddUpdateReviews", arrList.ToArray())
    End Sub
    ...
    Public Function AddUpdateTourPackages(ByVal PackageId As Integer, ByVal PackageName As String, ByVal ShortDesc As String,
        ByVal PackageDesc As String, ByVal PackageItinerary As String, ByVal PackageInclusion As String, ByVal PackageDays As String,
        ByVal PackagePricePP As String, ByVal LocationEmbed As String, ByVal RoadMap As String, ByVal RoadMapImg As String,
        ByVal Image1 As String, ByVal Image2 As String, ByVal Image3 As String, ByVal Image4 As String,
        ByVal Categories As String, ByVal UserName As String, ByVal DeActivated As Integer, ByVal PageURL As String, ByVal ShowOnHomePage As Integer) As String

        Dim result As String
        Dim arrList As New ArrayList
        arrList.Add(PrepareCommand("@PackageId", PackageId, SqlDbType.Int, 0, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@PageURL", PageURL, SqlDbType.NVarChar, 200, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@PackageName", PackageName, SqlDbType.NVarChar, 1000, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@ShortDesc", ShortDesc, SqlDbType.NVarChar, 2000, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@PackageDesc", PackageDesc, SqlDbType.NVarChar, -1, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@PackageItinerary", PackageItinerary, SqlDbType.NVarChar, -1, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@PackageInclusion", PackageInclusion, SqlDbType.NVarChar, -1, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@PackageDays", PackageDays, SqlDbType.VarChar, 1000, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@PackagePricePP ", PackagePricePP, SqlDbType.VarChar, 1000, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@LocationEmbed", LocationEmbed, SqlDbType.NVarChar, 500, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@RoadMap", RoadMap, SqlDbType.NVarChar, -1, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@RoadMapImg", RoadMapImg, SqlDbType.VarChar, 200, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@Image1", Image1, SqlDbType.VarChar, 200, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@Image2", Image2, SqlDbType.VarChar, 200, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@Image3", Image3, SqlDbType.VarChar, 200, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@Image4", Image4, SqlDbType.VarChar, 200, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@Categories", Categories, SqlDbType.VarChar, 1000, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@DeActivated", DeActivated, SqlDbType.Int, 0, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@ShowOnHomePage", ShowOnHomePage, SqlDbType.Int, 0, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@UserName", UserName, SqlDbType.VarChar, 200, ParameterDirection.Input))
        ...
        Return result
    End Function
    Public Function UpdateTourImages(ByVal PackageId As Integer, ByVal Image1 As String, ByVal Image2 As String,
        ByVal Image3 As String, ByVal Image4 As String, ByVal Image5 As String, ByVal Image6 As String) As String
        ...
        arrList.Add(PrepareCommand("@Image3", Image3, SqlDbType.VarChar, 200, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@Image4", Image4, SqlDbType.VarChar, 200, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@Image5", Image5, SqlDbType.VarChar, 200, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@Image6", Image6, SqlDbType.VarChar, 200, ParameterDirection.Input))
        result = ExecNonQueryProc("Prc_UpdateTourImages", arrList.ToArray())
        Return result
    End Function
    Public Function UpdateTourDeparturesImages(ByVal PackageId As Integer, ByVal Image1 As String, ByVal Image2 As String,
        ByVal Image3 As String, ByVal Image4 As String, ByVal Image5 As String, ByVal Image6 As String) As String
        ...
        arrList.Add(PrepareCommand("@Image5", Image5, SqlDbType.VarChar, 200, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@Image6", Image6, SqlDbType.VarChar, 200, ParameterDirection.Input))
        result = ExecNonQueryProc("Prc_UpdateTourDeparturesImages", arrList.ToArray())
        Return result
    End Function
    ...
    Public Function GetPageURL(ByVal PageTitle As String) As String
        ...
        pageurl = GetAccentedStr(pageurl)
        Return pageurl
    End Function
    ...
    Public Function GetTourPackages(ByVal TourPackageCategory As String, ByVal TourPackage As String, ByVal Deactivated As Integer) As SqlDataReader
        ...
        Return dr
    End Function
    Public Function GetTourDepartures(ByVal TourPackage As String, ByVal Deactivated As Integer) As SqlDataReader
        Dim arrList As New ArrayList
        arrList.Add(PrepareCommand("@TourPackage", TourPackage, SqlDbType.NVarChar, 200, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@DeActivated", Deactivated, SqlDbType.Int, 0, ParameterDirection.Input))
        Dim dr As SqlDataReader = ExecDataReaderProc("Prc_GetTourDepartures", arrList.ToArray)
        Return dr
    End Function
    Public Function GetAccentedStr(ByVal accentedStr As String) As String
        Dim tempBytes() As Byte
        tempBytes = System.Text.Encoding.GetEncoding("ISO-8859-8").GetBytes(accentedStr)
        Dim asciiStr As String = System.Text.Encoding.UTF8.GetString(tempBytes)
        Return asciiStr
    End Function
    Public Function AddUpdateTourDepartures(ByVal PackageId As Integer, ByVal PackageName As String, ByVal DepartureDate As String, ByVal ShortDesc As String,
        ByVal PackageDesc As String, ByVal PackageItinerary As String, ByVal PackageInclusion As String, ByVal PackageDays As String,
        ByVal PackagePricePP As String, ByVal LocationEmbed As String, ByVal RoadMap As String, ByVal RoadMapImg As String,
        ByVal Image1 As String, ByVal Image2 As String, ByVal Image3 As String, ByVal Image4 As String,
        ByVal UserName As String, ByVal DeActivated As Integer, ByVal PageURL As String, ByVal DepartureStatus As String, ByVal BookingClosed As Integer) As String
        ...
        arrList.Add(PrepareCommand("@PageURL", PageURL, SqlDbType.NVarChar, 200, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@PackageName", PackageName, SqlDbType.NVarChar, 1000, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@DepartureDate", DepartureDate, SqlDbType.VarChar, 200, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@ShortDesc", ShortDesc, SqlDbType.NVarChar, 2000, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@PackageDesc", PackageDesc, SqlDbType.NVarChar, -1, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@PackageItinerary", PackageItinerary, SqlDbType.NVarChar, -1, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@PackageInclusion", PackageInclusion, SqlDbType.NVarChar, -1, ParameterDirection.Input))
        ...
        arrList.Add(PrepareCommand("@DeActivated", DeActivated, SqlDbType.Int, 0, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@UserName", UserName, SqlDbType.VarChar, 200, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@DepartureStatus", DepartureStatus, SqlDbType.NVarChar, 2000, ParameterDirection.Input))
        arrList.Add(PrepareCommand("@BookingClosed", BookingClosed, SqlDbType.Int, 0, ParameterDirection.Input))
        result = ExecNonQueryProc("Prc_AddUpdateTourDepartures", arrList.ToArray())
        Return result
    End Function
    Public Function GetCurrencyRate(ByVal Currency As String) As Decimal
        Dim urlstr As String = "https://www.alphavantage.co/query?function=CURRENCY_EXCHANGE_RATE&from_currency=" & Currency & "&to_currency=INR&apikey=3LGI04Y9RWM7SBFN"
        Dim json As String = WebRequestForRate(Method.GET, urlstr, String.Empty)
        Dim ResponseJSONJObj As JObject = JObject.Parse(json)
        Dim Value2 As Decimal = 0
        Value2 = ResponseJSONJObj("Realtime Currency Exchange Rate")("5. Exchange Rate")
        Return Value2
    End Function
    Public Enum Method
        [GET]
        POST
    End Enum
    Public Function WebRequestForRate(ByVal MType As Method, ByVal url As String, ByVal postData As String) As String
