        ...
        Try
            ...
            If FileUpload.HasFile Then
                ...
                If FileUpload.PostedFile.ContentType.Split("/")(0) = "image" Then
                    ...
                    CreateThumbnail(400, Server.MapPath(System.Configuration.ConfigurationManager.AppSettings("gallaryimagepath")) + File, Server.MapPath(System.Configuration.ConfigurationManager.AppSettings("gallarythumbnailpath")) + File)
                End If
            End If
