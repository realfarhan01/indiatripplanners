<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="false" CodeFile="WebsiteQueries.aspx.vb" Inherits="Admin_WebsiteQueries" %> <asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server"></asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="C1" Runat="Server">
   <div class="form-horizontal">
      <div class="panel panel-default">
         <div class="panel-heading">
            <h6 class="panel-title">Booking Queries</h6>
         </div>
               ...
               <Columns>
                  ...
                  <asp:TemplateField ItemStyle-Width="200px">
                     ...
                     <ItemTemplate> 
                         ...
                         Children: <%#Eval("City") %> <br />
                         No. of Travelers: <%#Eval("NoOfPerson") %> <br />
                         Hotel: <%#Eval("Hotel") %> <br /> 
                         Check-In Date: <%#Eval("CheckInDate") %> <br /> 
                         Check-Out Date: <%#Eval("CheckOutDate") %> <br /> 
                         Vehicle Type: <%#Eval("Budget") %> <br /> 
                         Message: <%#Eval("Civility") %> 
                     </ItemTemplate>
                  </asp:TemplateField>
