...
Partial Class Admin_departures
    ...
    Protected Sub btnsubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSubmit.Click
        Try
            ...
            Dim Result As String = BLL.AddUpdateTourDepartures(hfId.Value, txtProductName.Text, txtDate.Text, txtShortDesc.Text, txtProductDesc.Text, txtPackageItinerary.Text, txtPackageInclusion.Text, txtPackageDays.Text, txtPackagePricePP.Text, txtLocationEmbed.Text, txtRoadMap.Text, File5, File1, File2, File3, File4, user, ddlStatus.SelectedValue, PageURL, txtDepartureStatus.Text, ddlBookingClosed.SelectedValue)
            showdata()
            div1.Visible = False
            div2.Visible = True
            div3.Visible = False
    ...
    Protected Sub DataDisplay_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles DataDisplay.RowCommand
        ...
        ElseIf e.CommandName = "Deactivate1" Then
            ...
            Dim dr As SqlDataReader = BLL.ExecDataReader("select *,convert(varchar(20),DepartureDate,103)Dated from tblTourDepartures where PackageId=@PackageId and UserName=@UserName", "@PackageId", e.CommandArgument, "@UserName", System.Configuration.ConfigurationManager.AppSettings("UserName"))
            If dr.Read Then
                ...
                txtDate.Text = dr("Dated").ToString()
                ...
                ddlBookingClosed.SelectedValue = dr("BookingClosed")
                txtDepartureStatus.Text = dr("DepartureStatus")
    ...
    Private Sub btnAddTourImages_Click(sender As Object, e As EventArgs) Handles btnAddTourImages.Click
        Try
            ...
            'Dim PageURL As String = BLL.GetPageURL(txtProductName.Text)
            'Dim FolderPath As String = System.Configuration.ConfigurationManager.AppSettings("UserName")
            Dim Result As String = BLL.UpdateTourDeparturesImages(hfId.Value, File1, File2, File3, File4, File5, File6)
            showdata()
            'div1.Visible = False
            'div3.Visible = False
            'div2.Visible = True
