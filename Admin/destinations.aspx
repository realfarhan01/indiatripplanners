<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="false" ValidateRequest="false" CodeFile="destinations.aspx.vb" Inherits="Admin_destinations" %>
...
<!-- Form components -->
            <div class="form-horizontal" >
                ...
                <div class="panel panel-default" id="div1" runat="server">
                    ...
                    <div class="panel-body">
                       ...
                       <%-- <div class="alert alert-info fade in widget-inner">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Destination Image </label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Detail Description </label>
                            <div class="col-sm-10">
                ...
                <div class="panel-heading"><h6 class="panel-title">Destination List</h6>
                ...
                <div class="table-responsive">
                        ...
                        <Columns>
                            ...
                            <ItemTemplate>
                             ...
                             <asp:TemplateField>
                                 <ItemTemplate>
                                     <a href='../images/destinations/<%#Eval("ImageName") %>' target="_blank" >
                                    <img style="width:150px" alt="" src='../images/destinations/<%#Eval("ImageName") %>'></img></a>
                                 </ItemTemplate>
                             </asp:TemplateField>
