<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="false" ValidateRequest="false" CodeFile="departures.aspx.vb" Inherits="Admin_departures" %>
...
<!-- Form components -->
            ...
            <div class="form-horizontal" >
                ...
                <div class="panel panel-default" id="div1" runat="server">
                    <div class="panel-heading"><h6 class="panel-title">Add/Edit Departures </h6> 
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Tour Days </label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <asp:TextBox ID="txtDate" runat="server" placeHolder="Departure Date" Width="100px"  class="form-control datepicker"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Departure Status </label>
                            <div class="col-sm-10">
                                <asp:TextBox ID="txtDepartureStatus" class="form-control" runat="server"></asp:TextBox>
                            </div>
                        </div>
                         <div class="form-group">
                            <label class="col-sm-2 control-label">Booking </label>
                            <div class="col-sm-10">
                                <asp:DropDownList ID="ddlBookingClosed" class="select-full" runat="server">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Image 1 [1000x625]</label>
                            <div class="col-sm-10">
                                <asp:FileUpload ID="FileUpload1" CssClass="form-control" runat="server" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Image 2 [1000x625]</label>
                            <div class="col-sm-10">
                                <asp:FileUpload ID="FileUpload2" CssClass="form-control" runat="server" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Image 3 [1000x625]</label>
                            <div class="col-sm-10">
                                <asp:FileUpload ID="FileUpload3" CssClass="form-control" runat="server" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Image 4 [1000x625]</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Tour RoadMap Image [1000x625]</label>
                            <div class="col-sm-10">
                                <asp:FileUpload ID="FileUpload5" CssClass="form-control" runat="server" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Tour RoadMap Embed</label>
                            <div class="col-sm-10">
                    ...
                    <div class="panel panel-default" id="div3" runat="server">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Image 5 [1000x625]</label>
                                <div class="col-sm-10">
                                    <asp:FileUpload ID="FUImg5" CssClass="form-control" runat="server" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Image 6 [1000x625]</label>
                                <div class="col-sm-10">
                ...
                <div class="panel-heading"><h6 class="panel-title">Departure List</h6>
                    <span style="text-align:right;display:block;">
                        ...
                        <Columns>
                            ...
                            <ItemTemplate>
                             ...
                             <asp:TemplateField ItemStyle-Width="200px">
                                 <HeaderTemplate>Tour Name</HeaderTemplate>
                                 <ItemTemplate>
                                     <%#Eval("PackageName") %>                                                        
                                 </ItemTemplate>
                            </asp:TemplateField>
