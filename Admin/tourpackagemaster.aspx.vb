...
Partial Class Admin_tourpackagemaster
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            hfId.Value = 0
            chkCategories.DataSource = BLL.ExecDataTable("select ProductCategoryId,ProductCategory from tbl_ProductCategory Where UserName=@UserName and DeActivated=0 order by ProductCategoryId", "@UserName", System.Configuration.ConfigurationManager.AppSettings("UserName"))
            chkCategories.DataValueField = "ProductCategoryId"
            chkCategories.DataTextField = "ProductCategory"
    ...
    Protected Sub btnsubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSubmit.Click
        Try
            ...
            For Each itm As ListItem In chkCategories.Items
                If itm.Selected Then
                    Categories = Categories + itm.Value.ToString() + ","
                End If
            Next
            'Dim FolderPath As String = System.Configuration.ConfigurationManager.AppSettings("UserName")
            Dim Result As String = BLL.AddUpdateTourPackages(hfId.Value, txtProductName.Text, txtShortDesc.Text, txtProductDesc.Text, txtPackageItinerary.Text, txtPackageInclusion.Text, txtPackageDays.Text, txtPackagePricePP.Text, txtLocationEmbed.Text, txtRoadMap.Text, File5, File1, File2, File3, File4, Categories, user, ddlStatus.SelectedValue, PageURL, ddlShow.SelectedValue)
            showdata()
            div1.Visible = False
            div2.Visible = True
            div3.Visible = False
    ...
    Protected Sub DataDisplay_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles DataDisplay.RowCommand
        ...
        ElseIf e.CommandName = "Deactivate1" Then
            ...
            If dr.Read Then
                ...
                For Each itm As ListItem In chkCategories.Items
                    If dr("Categories").ToString().Contains("," & itm.Value.ToString() & ",") Then
                        itm.Selected = True
                    End If
                Next
    ...
    End Sub
    Sub showdata()
        DataDisplay.DataSource = BLL.ExecDataTable("Select *,(Case when DeActivated=0 then 'Active' Else 'DeActive' End)Status,dbo.GetCategories(tblTourPackages.Categories) ProductCategory from tblTourPackages Where Deactivated<=1 and UserName=@UserName", "@UserName", System.Configuration.ConfigurationManager.AppSettings("UserName"))
    ...
    Sub cleardata()
        ...
        txtShortDesc.Text = ""
        txtProductDesc.Text = ""
        txtPackageItinerary.Text = ""
        txtPackageInclusion.Text = ""
        txtPackageDays.Text = ""
        txtPackagePricePP.Text = ""
        txtLocationEmbed.Text = ""
        txtRoadMap.Text = ""
        ddlStatus.SelectedValue = 1
        ddlShow.SelectedValue = 0
        Image1 = ""
        Image2 = ""
        Image3 = ""
        Image4 = ""
